...
type: scalarType | classType | arrayType | paramType | arrayType | wildcard | symbolicType;
...
SCALAR:	'Character' | 'Integer' | 'Double' | 'Float' | 'Long' | 'Short' | 'Boolean' | 'String' | 'Void' | 'void';
