...
public abstract class NLS {
    ...
    // JO private static final String PROP_WARNINGS = "osgi.nls.warnings"; //$NON-NLS-1$
    // JO private static final String IGNORE = "ignore"; //$NON-NLS-1$
    private static final boolean ignoreWarnings = false; // JO
    ...
    private static void computeMissingMessages(String bundleName, Class<?> clazz, Map<Object, Object> fieldMap, Field[] fieldArray, boolean isAccessible) {
        ...
        for (int i = 0; i < numFields; i++) {
            ...
            try {
                ...
                // JO if (Debug.DEBUG_MESSAGE_BUNDLES)
                // JO	System.out.println(value);
    ...
    static void load(final String bundleName, Class<?> clazz) {
        // JO long start = System.currentTimeMillis();
        ...
        // JO if (Debug.DEBUG_MESSAGE_BUNDLES)
        // JO	System.out.println("Time to load message bundle: " + bundleName + " was " + (System.currentTimeMillis() - start) + "ms."); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
    ...
    static void log(int severity, String message, Exception e) {
        ...
        // JO if (frameworkLog != null) {
        // JO	frameworkLog.log(new FrameworkLogEntry("org.eclipse.osgi", severity, 1, message, 0, e, null)); //$NON-NLS-1$
        // JO	return;
        // JO}
        String statusMsg;
        switch (severity) {
