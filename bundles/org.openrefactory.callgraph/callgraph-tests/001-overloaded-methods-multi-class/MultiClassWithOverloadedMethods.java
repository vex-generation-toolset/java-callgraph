...
/*$$$$$ MultiClassWithOverloadedMethods.main(String[]), 5,
		39,15, 1, A.<init>(),
		42,23, 1, B.<init>(),
		45,15, 1, C.<init>(),
		42,17, 4, A#foo(A), C#foo(A), B#foo(A), D#foo(A),
		46,9, 4, A#foo(A), C#foo(A), B#foo(A), D#foo(A)
*/
...
/*$$$$$ D#foo(A), 3,
		17,15, 1, B.<init>(),
		19,16, 1, A.<init>(),
		18,9, 4, B#foo(A), A#foo(A), C#foo(A), D#foo(A)
*/
